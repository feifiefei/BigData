...
public class SocketServer {
    ...
    private static List<String> parseStockFile() {
        ...
        try {
            //本地磁盘路径
//            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("E:\\export\\servers\\tmp\\socket\\szse-stock.txt")),"UTF-8"));
            //服务器磁盘路径
    ...
    public static List<String> parseIndexFile() {
        ...
        try {
            //本地磁盘路径
//            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("E:\\export\\servers\\tmp\\socket\\szse-index.txt")),"UTF-8"));
            //服务器磁盘路径
