...
import com.itheima.MRtohbase.ReadHbaseTable;
...
/**
 * Author: 飞
 * Date: 2020/9/23 0023 21:15
 * FileName: readCellToNewCell
 * Description: hbase通过MapReduce读表至新表
 */
public class readCellToNewCell extends Configured implements Tool {

    public int run(String[] args) throws Exception {
        //todo:1-创建
        Job job = Job.getInstance(this.getConf(), "read");
        job.setJarByClass(readCellToNewCell.class);
        //todo:2-配置
        //input&map
        /**
        ...
        TableMapReduceUtil.initTableMapperJob(
                "student:stu_info",
                scan,
                ReadHbaseTable.ReadHbaseMap.class,
                Text.class,
                Text.class,
                job
        );
