...
/**
 * @description:cep识别恶意用户
 * @author: 飞
 * @date: 2020/11/4 0004 17:16
 */
public class MaliceUser {
    //如果用户在10s内，输入了TMD5次，就认为用户为恶意攻击，识别出该用户
    public static void main(String[] args) throws Exception {
        ...
        //定义模式规则
        //用户如果在10s内输入TMD5次，就认为用户为恶意攻击，识别出该用户
        Pattern<Message, Message> pattern = Pattern.<Message>begin("begin")//begin:表示是模式规则的名称
